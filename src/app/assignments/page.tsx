...
const AssignmentsPageComponent = () => {
  ...
  const fetchData = React.useCallback(async () => {
    ...
    try {
      if (!appUser.role.includes('Admin') && !appUser.role.includes('Folk Guide')) {
        setFetchError(new Error("You do not have permission to view this page."));
        return;
      }
                                    ...
                                    <div className="space-y-4">
                                      ...
                                      <div className="grid gap-3">
                                        ...
                                        <div className="space-y-1.5">
                                          <Label className="text-[10px] font-black uppercase text-muted-foreground">Quick Batches</Label>
                                          <div className="flex flex-wrap gap-1">
                                            <Button variant="ghost" className="h-7 px-2 text-[10px] font-bold border" onClick={() => { setRangeFrom("1"); setRangeTo("30"); handleSelectRange("1", "30"); }}>30</Button>
                                            <Button variant="ghost" className="h-7 px-2 text-[10px] font-bold border" onClick={() => { setRangeFrom("1"); setRangeTo("60"); handleSelectRange("1", "60"); }}>60</Button>
                                            <Button variant="ghost" className="h-7 px-2 text-[10px] font-bold border" onClick={() => { setRangeFrom("1"); setRangeTo("100"); handleSelectRange("1", "100"); }}>100</Button>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
