...
const CallingAssistantPageComponent = () => {
  ...
  return (
    <>
        ...
        <AssignCoEnablerDialog isOpen={isAssignCoEnablerDialogOpen} setIsOpen={setIsAssignCoEnablerDialogOpen} onSave={async (u) => { if (u) await assignCoEnablerToPeople(Array.from(selectedIds), u, appUser!); fetchData(undefined, true); setSelectedIds(new Set()); }} peopleCount={selectedIds.size} selectedPersonIds={Array.from(selectedIds)} />
