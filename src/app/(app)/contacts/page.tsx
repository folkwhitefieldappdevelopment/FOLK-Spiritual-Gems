        ...
        <Tabs value={activeTab} onValueChange={(v) => { setActiveTab(v); }} className="w-full">
            <div className="overflow-x-auto scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0">
                <TabsList className="mb-8 flex w-max sm:w-full h-auto p-1.5 bg-card border-none rounded-2xl gap-1.5 min-w-full">
                    ...
                    <TabsTrigger value="my-groups" className="flex-1 py-3 px-8 text-[9px] sm:text-[10px] font-black uppercase tracking-widest rounded-xl data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=inactive]:text-muted-foreground whitespace-nowrap uppercase">GROUPS (MINE)</TabsTrigger>
                    <TabsTrigger value="all-groups" className="flex-1 py-3 px-8 text-[9px] sm:text-[10px] font-black uppercase tracking-widest rounded-xl data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=inactive]:text-muted-foreground whitespace-nowrap uppercase">GROUPS (SHARED)</TabsTrigger>
                </TabsList>
            </div>
