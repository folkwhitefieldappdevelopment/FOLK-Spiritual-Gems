      ...
      <DialogContent className="sm:max-w-md bg-popover border-none rounded-[2rem] shadow-2xl">
        <DialogHeader className="space-y-3">
          ...
          <div className="space-y-1">
            <DialogTitle className="text-xl font-black text-foreground uppercase tracking-tight">Add Interaction Details</DialogTitle>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-5 py-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-2">
                  <FormLabel className="text-[10px] font-black uppercase text-muted-foreground tracking-widest ml-1">Call Outcome</FormLabel>
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                      <SelectTrigger className="h-12 rounded-xl border-border bg-muted text-foreground font-bold px-5">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-2">
                  <FormLabel className="text-[10px] font-black uppercase text-muted-foreground tracking-widest ml-1">Notes / Remarks</FormLabel>
                  <FormControl>
                    <Textarea 
                      placeholder="Enter details about the conversation..." 
                      className="min-h-[120px] rounded-xl border-border bg-muted text-foreground font-bold p-4 resize-none focus-visible:ring-primary"
                      {...field} 
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <DialogFooter className="pt-2 gap-3">
              <Button type="button" variant="ghost" onClick={() => setIsOpen(false)} className="rounded-xl font-bold text-muted-foreground hover:text-foreground">
                Cancel
              </Button>
