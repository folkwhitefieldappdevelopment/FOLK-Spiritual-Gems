      ...
      <div className="w-full max-w-lg pt-12 pb-20 space-y-8">
        <div className="text-center space-y-3 animate-in fade-in duration-700">
          <h1 className="text-4xl font-black text-foreground tracking-tight">
            Hey, glad you're <span className="text-orange-500">here!</span>
          </h1>
            ...
            {step === 'assignment' ? (
                <div className="p-10 space-y-10">
                    <div className="text-center space-y-4">
                        <div className="bg-muted p-6 rounded-[2rem] w-fit mx-auto shadow-inner border border-border">
                    ...
                    <div className="space-y-6">
                        ...
                        <Button 
                            className="w-full h-16 rounded-2xl bg-orange-500 hover:bg-orange-600 text-black font-black text-xl shadow-xl shadow-orange-500/20 transition-all hover:scale-[1.01]" 
                            ...
                            {showCamera ? (
                                <div className="w-full space-y-4">
                                    ...
                                    <div className="flex justify-center gap-4">
                                        ...
                                        <Button className="rounded-xl bg-orange-500 text-black font-black px-10" onClick={handleCapture}>Take Snap</Button>
                                    </div>
                                </div>
                            ) : (
                                <div className="w-full rounded-[2rem] border-2 border-dashed border-border bg-muted/50 p-8 flex flex-col items-center justify-center text-center gap-4">
                                    {photoPreview ? (
                                        <Avatar className="h-24 w-24 rounded-2xl border-2 border-orange-500">
                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                <FormField control={form.control} name="organisation" render={({ field }) => (
                                    <FormItem className="space-y-2">
                                        ...
                                        <FormControl><Input placeholder="e.g. PES University, TCS" className="h-14 rounded-xl border-none bg-muted text-foreground font-bold px-6 focus-visible:ring-orange-500" {...field} /></FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )} />
                                ...
                                <div className="bg-muted/50 rounded-2xl p-4 flex gap-4 border border-border">
                                    ...
                                    <p className="text-[10px] text-muted-foreground leading-relaxed font-bold pt-0.5">
                                        <span className="text-orange-500 uppercase">Your info stays with us.</span> This is just so our team knows who you are. We won't spam, sell, or share your details with anyone.
                                    </p>
                                </div>

                                <Button 
                                    className="w-full h-16 rounded-2xl bg-orange-500 hover:bg-orange-600 text-black font-black text-lg shadow-xl shadow-orange-500/20 mt-4 transition-all active:scale-95" 
