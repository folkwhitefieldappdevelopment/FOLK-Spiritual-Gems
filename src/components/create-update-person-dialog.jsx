...
export function CreateUpdatePersonDialog({
  ...
  const [enablerOptions, setEnablerOptions] = React.useState([]);
  const [contactSourceOptions, setContactSourceOptions] = React.useState([]);
  const [customFields, setCustomFields] = React.useState([]);
  const [customData, setCustomData] = React.useState({});
  const [folkGuides, setFolkGuides] = React.useState([]);
