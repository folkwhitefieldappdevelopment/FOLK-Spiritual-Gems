    ...
    return (
      <Form {...form}>
        <form id="person-details-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <FormField control={form.control} name="fromOtherCamp" render={({ field }) => (<FormItem className="flex flex-row items-center space-x-2 pt-2"><FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} /></FormControl><FormLabel className="!mt-0">From another camp?</FormLabel></FormItem>)} />
    ...
    <div className="space-y-6">
       <div className="flex flex-col items-center text-center">
            ...
            <DialogTrigger asChild>
                <Avatar className={cn("mb-4 cursor-pointer hover:opacity-80 transition-opacity", isInDialog ? "h-24 w-24" : "h-32 w-32")}>
